...
1- ➺ Cobra Codes τм: https://discord.gg/ZyrtNXh
2- ➺ Cobra Games: https://discord.gg/bvY29N4
3- ➺ Cobra: https://discord.gg/WNqGD7M  "))
 {
...
client.on('message',async message => {
  ...
  /// code help
    ...
    client.on('message', message => { ///   
  if (message.content.startsWith(prefix + 'help')) { /// And This is The Channel One Send The Help In Channel // Code By BOT COBRA.
      let pages = [`
  ༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻
  〖 вσт cσвяα 〗 ➙   ✎  
@!       Ax7 🍺.#0010
